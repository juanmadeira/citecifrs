            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <div class="m-auto py-3 text-center form-sucess">
                        ...
                        <p class="text-center">Cadastro enviado com sucesso!</p>
                        <p class="text-center">Por favor, aguarde nossa análise para em breve exibirmos seu projeto em nosso site.</p>
                    </div>
                </div>
            </section>
        </main>
